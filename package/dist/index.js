(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactDropdownCheckList"] = factory();
	else
		root["ReactDropdownCheckList"] = factory();
...
var DATA_KEYNAME = exports.DATA_KEYNAME = "$$key$$";
var LISTITEM_CLASSNAME = exports.LISTITEM_CLASSNAME = "ddcl__item";
var ITEMCHECK_CLASSNAME = exports.ITEMCHECK_CLASSNAME = "ddci__check";
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                items.map(function (item) {
                    return _react2.default.createElement(_Item2.default, { key: item[Constants.DATA_KEYNAME],
                        item: item,
                        options: options,
...
var _DropdownCheckList = __webpack_require__(23);
...
var _Utils_ddlSingleLevel = __webpack_require__(44);

var Utils_ddlSingleLevel = _interopRequireWildcard(_Utils_ddlSingleLevel);

var _Utils_ddlMultiLevel = __webpack_require__(45);

var Utils_ddlMultiLevel = _interopRequireWildcard(_Utils_ddlMultiLevel);
...
var DropdownCheckList = function (_Component) {
    ...
    function DropdownCheckList(props) {
        ...
        _this.onCheckChanged = function (e) {
            ...
            var checkedItems = Utils.getCheckInfo(singleSelect, flatItems);
            _this.props.onCheckItemsChanged(checkedItems);
        };
        ...
        _this.onExpandClick = function (e) {
            ...
            try {
                for (var _iterator = flatItems[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        _this.onFilterChange = function (value) {
            ...
            var _this$props = _this.props,
                isAbleToCopyPaste = _this$props.isAbleToCopyPaste,
                singleSelect = _this$props.singleSelect;


            Utils.filter(value, flatItems, { isAbleToCopyPaste: isAbleToCopyPaste, singleSelect: singleSelect });

            if (isAbleToCopyPaste) {
                _this.updateSelectedText();
                _this.props.onCheckItemsChanged(Utils.getCheckInfo(singleSelect, flatItems));
            }

            _this.setState({ flatItems: flatItems, searchValue: value });
        };

        _this.updateSelectedText = function () {
            _this.setState({
                selectedTextElement: Utils.getSelectedText(_this.props, _this.state.maxLevel, _this.state.flatItems)
            });
        };
    ...
    _createClass(DropdownCheckList, [{
        ...
        value: function componentWillMount() {
            ...
            var dataSource = options.dataSource,
                ...
                parentIdName = options.parentIdName,
                countLevel = options.countLevel,
            ...
            var normalizedData = idName && parentIdName ? Utils_ddlMultiLevel.buildHierarchyCollection(dataSource, flatItems, options) : Utils_ddlSingleLevel.normalizeData(dataSource, flatItems, options);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                listVisible ? _react2.default.createElement(_Body2.default, (_React$createElement = {
...
exports.autoChecks = autoChecks;
exports.findMaxlevel = findMaxlevel;
exports.getSelectedText = getSelectedText;
exports.getCheckInfo = getCheckInfo;
exports.getItemByKey = getItemByKey;
exports.filter = filter;
exports.toggleSingleChangeStatus = toggleSingleChangeStatus;
exports.toggleChangeStatus = toggleChangeStatus;
...
function addRootNode(normalizedData, flatItems, options) {
...
function getSelectedText(options, maxLevel, flatItems) {
    var selectAllText = options.selectAllText,
        noSelectedText = options.noSelectedText,
        multipleSelectedText = options.multipleSelectedText,
        singleSelect = options.singleSelect;
...
function getCheckInfo(singleSelect, flatItems) {
    var selectedItems = [];
    ...
    try {
        for (var _iterator3 = flatItems[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
function getItemByKey(dataKeyValue, flatItems) {
    return flatItems.find(function (item) {
        return item && item[Constants.DATA_KEYNAME] == dataKeyValue;
    });
}

function filter(keyword, flatItems, _ref) {
    var isAbleToCopyPaste = _ref.isAbleToCopyPaste,
        singleSelect = _ref.singleSelect;

    if (keyword) {
        setDisplayItems(false, flatItems);
        var singleKeywordLower = keyword.toLowerCase();

        var filterByKeyWord = function filterByKeyWord(key) {
            var itemsFiltered = flatItems.filter(function (item) {
                return item && item.text.toLowerCase().includes(key);
            });
        ...
        var multiKeywordLower = singleKeywordLower.split(",").map(function (item) {
            return item.trim();
        });
...
function toggleSingleChangeStatus(itemData, checkedStatus, flatItems, singleSelect) {
...
function setChildrenCheckedStatus(itemData, checkedStatus, flatItems) {
    var parent = flatItems.find(function (item) {
        return item && item[Constants.DATA_KEYNAME] == itemData[Constants.DATA_KEYNAME];
    });
    ...
    try {
        for (var _iterator4 = childItems[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
function setParentSingleCheckedStatus(itemData, flatItems) {
    ...
    try {
        for (var _iterator5 = parentListItems[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
function toggleChangeStatus(itemData, checkedStatus, flatItems) {
    itemData.checked = checkedStatus;
    setChildrenCheckedStatus(itemData, checkedStatus, flatItems);
...
function setParentCheckedStatus(itemData, checkedStatus, flatItems) {
    ...
    var _loop2 = function _loop2() {
        var parentElement = parentListItems.shift();
        var nonCheckedItem = flatItems.find(function (item) {
            return item && item.ADNCode.indexOf(parentElement.ADNCode + ".") != -1 && !item.checked;
        });
    ...
    try {
        for (var _iterator6 = parentListItems[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
...
function getParentListItemsByKey(key, flatItems) {
    var childItem = flatItems.find(function (item) {
        return item && item[Constants.DATA_KEYNAME] == key;
    });
    ...
    while (existsAtLeastOneParent) {
        var parent = flatItems.find(function (item) {
            return item && item.ADNCode == ADNCodeToFind;
        });
        if (parent) {
...
function setDisplayItems(isDisplay, items) {
    ...
    try {
        for (var _iterator7 = items[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
            ...
            if (item) item.isDisplay = isDisplay;
        }
    } catch (err) {
...
function normalizeData(dataSource, flatItems, options) {
    var level = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1;
    var parentADNCode = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : "0.1";
    var displayName = options.displayName,
        checkedName = options.checkedName,
        selectAll = options.selectAll,
        expandedName = options.expandedName,
...
exports.buildHierarchyCollection = buildHierarchyCollection;
...
function buildHierarchyCollection(dataSource, flatItems, options) {
    var parentIdName = options.parentIdName,
        idName = options.idName,
    ...
    var newItemData = void 0,
        id = void 0;
    var resolveParentMissing = function resolveParentMissing(item) {
...
var DropdownCheckListPropTypes = exports.DropdownCheckListPropTypes = {
    ...
    onCheckItemsChanged: _propTypes2.default.func.isRequired,
    isAbleToCopyPaste: _propTypes2.default.bool
};
...
var DropdownCheckListDefaultProps = exports.DropdownCheckListDefaultProps = {
    ...
    countLevel: -1,
    // support copy/paste/typing to check item automiccally
    isAbleToCopyPaste: false
    ...
    _createClass(Body, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                showFilter && _react2.default.createElement(_Filter2.default, { width: width,
...
var Filter = function (_Component) {
    ...
    function Filter(props) {
        ...
        _this.onClearFilterClick = function () {
        ...
        _this.onFilterChange = function () {
            ...
            _this.inputText.value = _this.inputText.value.replaceAll("\n", _this.props.isAbleToCopyPaste ? ", " : " ");

            _this.filterDelayId = setTimeout(function () {
                _this.filterDelayId = 0;
                _this.props.onFilterChange(_this.inputText.value);
            }, _this.props.filterDelay * 1000);

            _this.setState({ searchValue: _this.inputText.value });
        };

        _this.onFilterKeyDown = function (event) {
            if (event.key === "Enter") {
    ...
    _createClass(Filter, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement("textarea", { className: "ddft__input ddft__input--textarea",
                    placeholder: "Filter",
                    autoFocus: true,
                    rows: 1,
...
var _ListItems = __webpack_require__(21);
...
var _CheckItem = __webpack_require__(54);
...
var Item = function (_Component) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var expandElement = void 0;
            var childElements = void 0;

            if (item.items && item.items.length > 0) {
                var attributeKey = { 'data-key': item[Constants.DATA_KEYNAME] };
            ...
            return _react2.default.createElement(
                'li',
                { className: Constants.LISTITEM_CLASSNAME + expandedClassName + singleClassName + rootClassName + levelClassName, style: { display: item.isDisplay ? "block" : "none" } },
